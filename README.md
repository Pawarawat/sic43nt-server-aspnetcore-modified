...
```
az webapp deployment source config --repo-url https://github.com/Pawarawat/sic43nt-server-aspnetcore-modified.git --branch master  --name <app_name> --resource-group <your-resource-group-name> --manual-integration
```
